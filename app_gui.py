...
import cv2
import os
from tracking_gui import VehicleTracker
import time
...
class VehicleTrackingApp:
    ...
    def setup_ui(self):
        ...
        self.camera_label = ttk.Label(input_frame, text="Camera ID:")
        self.camera_var = tk.StringVar(value="0")
        self.camera_entry = ttk.Entry(input_frame, textvariable=self.camera_var, width=10)
        
        # Number of lanes
        ttk.Label(input_frame, text="Số làn đường:").grid(row=3, column=0, sticky=tk.W, pady=5)
        self.lanes_var = tk.StringVar(value="3")
    ...
    def toggle_video_input(self):
        ...
        if self.source_var.get() == "camera":
            ...
            self.camera_entry.grid(row=2, column=2, sticky=tk.W, padx=5, pady=5)
        else:
    ...
    def run_tracking(self):
        ...
        try:
            ...
            # Create tracker
            processor = VehicleTracker(model_path, TRACKER_CONFIG_PATH, classNames, classColors, lanes)
    ...
    def run_tracking_with_stop_check(self, processor, video_source):
        ...
        try:
            ...
            for frame_count, result in enumerate(results):
                ...
                processor.draw_n_count(frame, boxes, track_ids, clss, vehicle_counter)
                avg_speed = processor.cal_speed(frame, boxes, clss, track_ids, car_speed)
                ...
                if frame_count % (1800 / processor.vid_stride) == 0 and frame_count > 0:
                    ...
                    processor.cal_density(frame, processor.ema_value, avg_speed)
